...
public sealed partial class MainGenerator
{
	private const string _markerContent =
		//todo: xml docs for attribute parameters
		"""
		// <auto-generated/>

		#pragma warning disable CS9113 //Parameter read from semantics, false positive
		...
		namespace DbSourceMapper
		{
			...
			internal sealed class DbSourceModelAttribute<TCommand>(global::DbSourceMapper.ModelOptions options = global::DbSourceMapper.ModelOptions.None) : global::System.Attribute where TCommand : global::System.Data.Common.DbCommand {}
	...
	private const string _extensionsContent =
		...
		namespace DbSourceMapper
		{
			public static class DbCommandExtensions
			{
				...
				/// <typeparam name="TModel"> Type of the model used as a result of mapping.</typeparam>
				/// <returns>A mapped <typeparamref name="TModel"/> instance or <c>null</c> if the query result is empty.</returns>
				public static TModel? GetFirstOrNull<TModel, TCommand>(this TCommand command) 
					where TCommand: global::System.Data.Common.DbCommand
					where TModel: class, global::DbSourceMapper.IDbSourceModel<TModel, TCommand>
					=> TModel.GetFirstOrNull(command);
				...
				/// <typeparam name="TModel"> Type of the model used as a result of mapping.</typeparam>
				/// <returns>A <see cref="List{}" /> of mapped <typeparamref name="TModel"/>s.</returns>
				public static global::System.Collections.Generic.List<TModel> GetListOf<TModel, TCommand>(this TCommand command)
					where TCommand: global::System.Data.Common.DbCommand
					where TModel: class, global::DbSourceMapper.IDbSourceModel<TModel, TCommand>
					=> TModel.GetList(command);
				...
				/// <typeparam name="TModel"> Type of the model used as a result of mapping.</typeparam>
				/// <returns>A lazily evaluated <see cref="IEnumerable{}"/> of mapped <typeparamref name="TModel"/>s.</returns>
				public static global::System.Collections.Generic.IEnumerable<TModel> GetEnumerableOf<TModel, TCommand>(this TCommand command)
					where TCommand: global::System.Data.Common.DbCommand
					where TModel: class, global::DbSourceMapper.IDbSourceModel<TModel, TCommand>
					=> TModel.GetEnumerable(command);
