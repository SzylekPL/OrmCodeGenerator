...
public sealed partial class MainGenerator
{
	private const string _markerContent =
		...
		namespace OrmGenerator
		{
			...
			internal sealed class OrmModelAttribute(global::OrmGenerator.ModelOptions options = global::OrmGenerator.ModelOptions.None) : global::System.Attribute {}
	...
	private const string _extensionsContent =
		...
		namespace OrmGenerator
		{
			...
			{
				private static TModel GetSingleModel<TModel>(global::System.Data.Common.DbDataReader reader) where TModel: class, global::OrmGenerator.IOrmModel<TModel>
				{
					int index = 0;
				...
				public static TModel? GetFirstOrNull<TModel>(this global::System.Data.Common.DbCommand command) where TModel: class, global::OrmGenerator.IOrmModel<TModel>
				{
				...
				public static async global::System.Threading.Tasks.Task<TModel?> GetFirstOrNullAsync<TModel>(this global::System.Data.Common.DbCommand command, global::System.Threading.CancellationToken token = default) where TModel: class, global::OrmGenerator.IOrmModel<TModel>
				{
				...
				public static global::System.Collections.Generic.List<TModel> GetListOf<TModel>(this global::System.Data.Common.DbCommand command) where TModel: class, global::OrmGenerator.IOrmModel<TModel>
				{
				...
				public static async global::System.Threading.Tasks.Task<global::System.Collections.Generic.List<TModel>> GetListOfAsync<TModel>(this global::System.Data.Common.DbCommand command, global::System.Threading.CancellationToken token = default) where TModel: class, global::OrmGenerator.IOrmModel<TModel>
				{
					global::System.Collections.Generic.List<TModel> result = [];
				...
				public static IEnumerable<TModel> GetEnumerableOf<TModel>(this global::System.Data.Common.DbCommand command) where TModel: class, global::OrmGenerator.IOrmModel<TModel>
				{
					using global::System.Data.Common.DbDataReader reader = command.ExecuteReader();
