...
public sealed partial class MainGenerator
{
	private const string _markerContent =
		...
		namespace DbSourceMapper
		{
			...
			[Microsoft.CodeAnalysis.Embedded]
			[global::System.AttributeUsage(global::System.AttributeTargets.Class)]
			internal sealed class DbSourceModelAttribute<TReader>(global::DbSourceMapper.ModelOptions options = global::DbSourceMapper.ModelOptions.None) : global::System.Attribute where TReader : global::System.Data.Common.DbDataReader {}
