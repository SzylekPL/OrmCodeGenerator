	...
	public void Initialize(IncrementalGeneratorInitializationContext context)
	{
		context.RegisterPostInitializationOutput(static ctx =>
		{
			...
			ctx.AddSource("DbCommandExtensions.g.cs",
				...
				{
					/// <summary>
					/// Executes the query contained in the <paramref name="DbCommand"/> parameter and maps the result to a single instance of <typeparamref name="TModel"/>.
					/// </summary>
					...
					/// <returns>A mapped <typeparamref name="TModel"/> or <c>null</c> if the query result is empty.</returns>
