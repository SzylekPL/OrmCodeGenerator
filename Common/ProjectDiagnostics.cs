...
internal static class ProjectDiagnostics
{
	...
	public static readonly ImmutableArray<DiagnosticDescriptor> DefinedDiagnostics = [_typeNotSupportedRule, _ctorNotSuitableRule, _typeNotSupportedByProviderRule];
}
